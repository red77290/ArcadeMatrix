...
EngineDescriptor ClockEngineDescriptorHandler::getDescriptor() const {
    ...
    clockDesc.schema.fields = {
        ...
        ConfigField("clock_speed", ConfigType::INTEGER, "Animation Speed", "Animation speed in percent (Tetris block fall); lower is slower", "100", false, "25", "300", "25", "", "", false, "", ValidationPolicy::Clamp),
